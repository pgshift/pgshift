...
<Tabs>
  ...
  <TabItem label="Workflow">
    ...
    await db.workflow('order-fulfillment').handlers({
      validateStock:   async (ctx) => { /* validate */ },
      validateFraud:   async (ctx) => { /* check fraud */ },
      chargeCard:      async (ctx) => { /* charge */ },
      refundCard:      async (ctx) => { /* compensation */ },
      emitInvoice:     async (ctx) => { /* invoice */ },
      voidInvoice:     async (ctx) => { /* compensation */ },
      sendEmail:       async (ctx) => { /* notify */ },
      updateAnalytics: async (ctx) => { /* record */ },
    })
